...
if getgenv().WbmxRan then
	warn("ALREADY OPEN")
	return
end
getgenv().WbmxRan=true
...
function CheckQ()
	...
	elseif L_25_ then
		...
		elseif MyLevel == 2200 or MyLevel <= 2224 then
			...
			CFrameQuest = CFrame.new(- 2021.32007, 37.7982254, - 12028.7295, 0.957576931, - 8.8030205e-8, 0.288177818, 6.930119e-8, 1, 7.519312e-8, - 0.288177818, - 5.2032135e-8, 0.957576931)
		...
		elseif MyLevel == 2250 or MyLevel <= 2274 then
			...
			CFrameQuest = CFrame.new(- 1927.91602, 37.7981339, - 12842.5391, - 0.96804446, 4.2214214e-8, 0.250778586, 4.7491106e-8, 1, 1.4990471e-8, - 0.250778586, 2.6421194e-8, - 0.96804446)
...
local L_30_ = CFrame.new(28734.3945, 14888.2324, - 109.071777, - 0.650207579, 4.178053e-8, - 0.759756625, 1.978766e-8, 1, 3.805751e-8, 0.759756625, 9.711478e-9, - 0.650207579)
...
local L_33_ = loadstring(game:HttpGet("https://you.whimper.xyz/sources/WbmxHub/ui.lua"))()
local L_34_ = L_33_:Window("Wbmx Hub 25ms was here", Enum.KeyCode.LeftControl)
print("|Wbmx DEBUG| Anti AFK")
game:GetService("Players").LocalPlayer.Idled:connect(function()
	print("|Wbmx DEBUG| AFK detected, prevented +1")
		...
		pcall(function()
			if _25msShared.AutoDoughBoss then
				...
				if L_185_.Visible == false and MyLevel >= 2200 then
					CFrameQuestDough = CFrame.new(- 2021.32007, 37.7982254, - 12028.7295, 0.957576931, - 8.8030205e-8, 0.288177818, 6.930119e-8, 1, 7.519312e-8, - 0.288177818, - 5.2032135e-8, 0.957576931)
...
spawn(function()
	print("|Wbmx DEBUG| Anti Stranger Join")
	while wait() do
		pcall(function()
			if _25msShared.AntiStranger then
				for L_222_forvar0, L_223_forvar1 in pairs(game:GetService("Players"):GetChildren()) do
					if L_223_forvar1.Data.Level.Value >= 2601 or L_223_forvar1.Data.Level.Value > 20000 then
						game.Players.LocalPlayer:Kick("Wbmx Hub found an Admin!")
						print("|Wbmx DEBUG| Detected Stranger, Hopping Server...")
						Hop()
					end
				end
			end
	...
	task.spawn(function()
		...
		if setfflag then
			task.spawn(function()
				...
				print("|Wbmx DEBUG| Anti Ban Loaded in: " .. os.clock() - L_228_)
			end)
		else
			print("|Wbmx DEBUG| Anti Ban not support this Executor!")
		end
	end)
end)
L_35_.Setting:Line()
				...
				if _25msShared.AutoRainbowHaki then
					...
					elseif game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true and string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Stone") then
						if game:GetService("Workspace").Enemies:FindFirstChild("Stone") then
							...
							TP(CFrame.new(- 1086.11621, 38.8425903, 6768.71436, 0.0231462717, - 0.592676699, 0.805107772, 0.000020325184, 0.805323839, 0.592835128, - 0.999732077, - 0.0137055516, 0.0186523199))
						end
					...
					elseif string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Captain Elephant") then
						if game:GetService("Workspace").Enemies:FindFirstChild("Captain Elephant") then
							...
							TP(CFrame.new(- 13485.0283, 331.709259, - 8012.4873, 0.714521289, 7.988499e-8, 0.69961375, - 1.0206575e-7, 1, - 9.943831e-9, - 0.69961375, - 6.4301524e-8, 0.714521289))
						end
					...
					if game:GetService("Players").LocalPlayer.Data.Level.Value >= 800 and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BartiloQuestProgress", "Bartilo") == 0 then
						if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Swan Pirates") and string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "50") and game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
							if game:GetService("Workspace").Enemies:FindFirstChild("Swan Pirate") then
								...
								repeat
									TP(CFrame.new(932.624451, 156.106079, 1180.27466, - 0.973085582, 4.5513712e-8, - 0.230443969, 2.6702471e-8, 1, 8.474911e-8, 0.230443969, 7.631471e-8, - 0.973085582))
									wait()
								until not _25msShared.AutoBartilo or (game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position - Vector3.new(932.624451, 156.106079, 1180.27466, - 0.973085582, 4.5513712e-8, - 0.230443969, 2.6702471e-8, 1, 8.474911e-8, 0.230443969, 7.631471e-8, - 0.973085582)).Magnitude <= 10
							end
						else
							repeat
...
L_35_.Info:Button("My Youtube (Click Copy)", function()
	setclipboard("https://www.youtube.com/@WbmxHub")
end)
...
task.delay(2, function()
	if hookfunction and not islclosure(hookfunction) then
		print("|Wbmx DEBUG| Remove Effects")
...
print("|Wbmx DEBUG| Done loaded Wbmx in: " .. os.clock() - L_1_)
